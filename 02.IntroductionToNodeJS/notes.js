...
3. NodeJs is a cross platform(It can be run on any device or Operating System).
...
5. Chrome(V8 Engine), Firfor(Spider Monkey), Safari(JavascriptCore)
...
8. In 2010, npm was build. NPM is a package manager for NodeJS. It is resitry where all the packages are build and stored.
